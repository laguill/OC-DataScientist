...
\pandocbounded{\includegraphics[keepaspectratio]{results/MLM.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/PLM.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/MPNET.png}}
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colback=white, rightrule=.15mm, breakable, bottomtitle=1mm, opacityback=0, arc=.35mm, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\emph{Pour rappel}}, bottomrule=.15mm, toprule=.15mm]
...
\pandocbounded{\includegraphics[keepaspectratio]{results/fig_acc.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/fig_bar_time.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/confusion_matrix.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/classification_reports.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/global_importances.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{results/local_importances.png}}
